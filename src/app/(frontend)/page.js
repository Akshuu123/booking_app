...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <DestinationSliderSection sliderTitle={"Top Destination"} data={fakeData} />
      <TestimonialSection />
      <CurateSection />
      <AiSection />
      <GuideSection sectionTitle={"Your Guide"} data={fakeData} /> {/* Guide Section (Blog) */}
      ...
      <div className="hidden sm:grid-cols-2 md:grid-cols-3 p-5 gap-4 items-center max-w-fit">
        ...
        <Testimonial username={""} email={""} title={""} imageSrc={""} date={""} />
