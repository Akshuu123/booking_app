...
export const CreatorCard = ({ imagSrc, rating, views, title, creatorLogo }) => {
    return (
        <div className='w-full max-w-full sm:max-w-sm  p-4 sm:p-6'>
            <img src={`${imagSrc ? imagSrc : "/assets/Card.png"}`} alt='card_image' className='sm:max-w-80 w-full min-h-[350px] h-full rounded-xl object-cover' />
            <div className='px-4 flex justify-between'>
                ...
                <div className='flex justify-between items-center'>
                    <img src={creatorLogo ? creatorLogo : '/assets/Card.png'} alt='card_image' className='size-11 rounded-full mt-4' />
                </div>
