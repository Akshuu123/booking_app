      ...
      <div className='relative'>
        ...
        <div className={`${stickyHeader ? 'hidden' : 'flex'} text-black bg-Brightgray px-12 py-4 w-full items-center justify-between `}>
          <div className="topheader offer flex space-x-6">
            <Link href={"/continent"}>Country</Link>

            <a href="/Get Exclusive offer on the App" className="text-Nileblue text-sm">Get Exclusive offer on the App</a>
        ...
        <div className="flex text-black px-12 py-4 w-full items-center bg-white">
          ...
          <nav className=" menu flex flex-grow justify-center space-x-10 flex-wrap">
            <button className="relative flex items-center text-Bluewhale font-medium" onClick={handleMegaMenu}>{/* This is Mega Menu Handle */}
            ...
            <a href="/Tours & Experiences" className="text-Bluewhale font-medium">Tours & Experiences</a>
            <a href="/Transfers" className="text-Bluewhale font-medium">Transfers</a>
            <Link href="/holiday" className="text-Bluewhale font-medium">Trips</Link>
            <Link href="/explore" className="text-Bluewhale font-medium">Explore</Link>
          </nav>
...
export const HeaderAccount = () => {
  ...
  return (
    <div>
      ...
      {showCart && createPortal(<Minicart showCart={showCart} setShowCart={setShowCart} />, document.body)}
