        ...
        <div className="flex flex-col gap-12">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="border rounded-xl pb-4">
                ...
                <div className="flex flex-col gap-4 px-6">
                            ...
                            <div className="mt-4 flex flex-col sm:flex-row gap-4">
                                <div className="w-full flex-[2]" >
                                    <input
                                        ...
                                        className={`border focus:outline-none p-2 rounded-lg w-full ${errors?.cardDetails ? "border-red-400" : ""}`}
                                    />
                                ...
                                <div className=" w-full flex-[1]">
                                    <input
                                        ...
                                        placeholder="CVV"
                                        maxLength={3}
                                        className={`border focus:outline-none p-2 rounded-lg w-full ${errors?.cvvDetails ? "border-red-400" : ""}`}
                        ...
                        {paymentMethod === "paypal" && (
                            <div className="mt-4">
                                <input
                                    ...
                                    className={`border focus:outline-none p-2 rounded-lg w-full ${errors?.paypalEmail ? "border-red-400" : ""}`}
                    ...
                    <div>
                        <button className=" underline text-secondaryDark">Enter Promo Code</button>
                        ...
                        <div className='flex justify-between flex-wrap sm:flex-nowrap gap-4'>
                            <div className='flex flex-col gap-1 w-full'>
                                <h3 className='capitalize text-lg font-semibold text-Blueish'>$6,790.18</h3>
                                <span className='capitalize underline text-[#5a5a5a]'>Detailed Breakdown</span>
                            </div>
                            <button type="submit" className='disabled:bg-gray-500 max-w-full w-fit py-3 px-9 text-nowrap capitalize rounded-md bg-secondaryDark text-[#ffffff] text-base font-medium'>{isSubmitting ? "Submitting..." : "Book Now"}</button>
                        </div>
