...
import { OverViewPanel, WhatIncludedPanel, ReviewPanel, FaqPanel, SingleProductForm, SingleProductSummary, ProductForm } from "./TabSection__modules"; // Separate components
...
const tabSection = () => {
  ...
  return (
    <section className="w-full border-2 bg-mainBackground singleProduct_tabSection">
      ...
      {/* Sticky Tab Bar */}
      <div
        className={`${fixedTab ? "fixed top-0 z-20" : ""} flex flex-col w-full  shadow-md bg-mainBackground`}>
...
//   if(this.window.screen.availHeight> this.window.screen.availHeight/50){
